      ...
      <form className="relative w-[319px] rounded-2xl border-3 border-[#292B2E] p-6 md:w-[865px]">
        ...
        <div className="relative">
          <textarea
            ...
            className="font-nanumSquare h-24 w-full resize-none rounded-xl bg-[#f5f5f5]/60 p-4 text-[14px] placeholder:text-[#808080] focus:outline-none md:p-5 md:text-[24px] dark:placeholder:text-white/70"
